...
{
    public class PwaAddResourcesInput : IPwaCommandInput
    {
        

        public PwaAddResourcesInput(NameValueCollection pwaInput)
        {
            this.Input = pwaInput;
        }
        ...
        public string[] ResUIDs { get; private set; }
        ...
        public IPwaCommandInput ParseInput()
        {
            ...
            this.ResUIDs = Input["resuids"].Split(",".ToCharArray());
