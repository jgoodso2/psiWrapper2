...
{
    public class PwaDeleteProjectPlanCommand : IPwaCommand, IPwaCommandFactory, IPwaOutput
    {
        ...
        public string PwaCommandDescription
        {
            get
            {
                return "PwaDeleteProjectPlanCommand - deletes a resource plan";
            }
        }
        ...
        public string PwaCommandName
        {
            get
            {
                return "PwaDeleteProjectPlanCommand";
            }
        }
        ...
        public void Execute()
        {
            try
            {
                ...
                ProjectPlan[] rp = (ProjectPlan[])Newtonsoft.Json.JsonConvert.DeserializeObject(PwaInput.ResourcePlans, (typeof(ProjectPlan[])));
        ...
        {
            return new PwaDeleteProjectPlanCommand() { _pj = pj, PwaInput = (PwaResourcePlanInput)new PwaResourcePlanInput(pwaInput).ParseInput() };
        }
